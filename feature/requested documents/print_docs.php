            ...
            <div class="flex py-6 px-8 gap-x-10">
                ...
                <div class="flex-1 text-lg">
                    ...
                    <div class="pt-12">
                        ...
                        <div class="pt-8">
                            <p class="indent-12 text-justify">This is to certify that <span class="uppercase"><?php echo $row['firstName'] . " " . $row['middleInitial'] . ". " . $row['lastName']; ?></span> a <span class="uppercase"><?php echo $row['age'] ?></span> years old, has been a resident of/at <span class="uppercase"><?php echo $row['address'] ?></span> this barangay since 2000 or for about 25 years of Residency.</p>
                        </div>
                    </div>
                    <div class="pt-8">
                        <p class="indent-12 text-justify">This Certification is being issued upon the request of this 24th day of June 2015 for (the) purpose/s of compliance with <?php echo $callSign ?> <span class="uppercase"> <?php echo $row['purpose']  ?></span> Requirements.</p>
                    </div>
