                        ...
                        <div class="flex-1 space-y-4 text-gray-800">
                            ...
                            <div class="flex">
                                <div class="mr-3 flex-1">
                                    ...
                                    <input required id="view_civilStatus" name="view_civilStatus" type="text" class="uppercase pe-9 w-full border-b border-gray-200 sm:text-xl focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none focus:outline-none placeholder-gray-800" readonly>
                                </div>
                                <div class="flex-1">
                                    <label for="view_contactNum" class="text-base font-medium">
                                        Contact Number
