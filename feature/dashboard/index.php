            ...
            <div>
                ...
                <div class="py-2 lg:py-4 mx-auto">
                    ...
                    <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
                        ...
                        <!-- Residents, Gender, Officials and Staff Data -->
                        <?php include('data_first_row.php') ?>
                        <!-- End of Residents, Gender, Officials and Staff Data -->

                        <!-- Certificates and Clearances Data -->
                        <?php include('data_second_row.php') ?>
                        <!-- End Certificates and Clearances Data -->

                        <!-- Blotters and Revenue Data -->
                        <?php include('data_third_row.php') ?>
                        <!-- End Blotters and Revenue Data -->
