    ...
    <div class="w-full lg:ps-64 min-h-screen">
        <div class="py-4 lg:py-8 px-8">
            <div class="hidden lg:flex items-center">
                ...
                <svg class="shrink-0 mx-2 overflow-visible size-4 text-gray-800" width="16" height="16"
                    viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M5 1L10.6869 7.16086C10.8637 7.35239 10.8637 7.64761 10.6869 7.83914L5 14"
                        stroke="currentColor" stroke-width="2" stroke-linecap="round" />
                </svg>
            ...
            <div class="md:flex lg:flex gap-x-8 lg:px-5 lg:py-8">
                <div class="flex flex-col items-center py-10">
                    <div class="hs-tooltip inline-block">
                        <div class="hs-tooltip-toggle relative inline-block">
                            ...
                            <div class="hs-tooltip-content hs-tooltip-shown:opacity-100 hs-tooltip-shown:visible opacity-0 transition-opacity inline-block absolute invisible z-10 py-1 px-2 bg-gray-900 text-xs font-medium text-white rounded-lg shadow-sm dark:bg-neutral-700"
                                role="tooltip">
                ...
                <div class="pt-5">
                    <div class="space-y-3">
                        <div>
                            <h2 class="font-bold text-gray-800 text-xl underline underline-offset-4 mb-6">Personal
                                Information</h2>
                        </div>
                        <div
                            class="flex lg:grid lg:grid-cols-[minmax(90px,200px)_30px_auto] md:grid md:grid-cols-[minmax(90px,200px)_30px_auto] sm:grid sm:grid-cols-[minmax(90px,200px)_30px_auto] gap-x-4 items-center text-gray-800">
                            <h3 class="font-semibold lg:text-lg">Full Name</h3>
                            <span class="font-semibold text-lg text-start text-black">:</span>
                            <span
                                class="font-semibold lg:text-lg uppercase"><?php echo $row['firstName'] . ' ' . $row['lastName']; ?></span>
                        </div>
                        ...
                        <div
                            ...
                            <span class="font-semibold text-lg text-start text-black">:</span>
                            <span
                                class="font-semibold lg:text-lg uppercase"><?php echo $row['address']; ?></span></span>
                        </div>
                        ...
                        <div
                            ...
                            <span class="font-semibold text-lg text-start text-black">:</span>
                            <span
                                class="font-semibold lg:text-lg uppercase"><?php echo $row['email_address']; ?></span></span>
                        </div>
                        <div
                            class="flex lg:grid lg:grid-cols-[minmax(90px,200px)_30px_auto] md:grid md:grid-cols-[minmax(90px,200px)_30px_auto] sm:grid sm:grid-cols-[minmax(90px,200px)_30px_auto] gap-x-4 items-center text-gray-800">
