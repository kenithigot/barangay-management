        ...
        <div class="p-8">
            ...
            <div>
                <div class="mt-12 grid sm:grid-cols-2 lg:grid-cols-3 items-center gap-4 lg:gap-8">
                    <!-- Icon Block -->
                    <a class="border-l-4 border-l-green-600 group flex flex-col h-full text-center rounded-lg border hover:bg-slate-200 focus:outline-none focus:bg-gray-100 p-4 sm:p-6" href="add account.php">
                    ...
                    <!-- Icon Block -->
                    <a class="border-l-4 border-l-green-600 group flex flex-col h-full text-center rounded-lg border hover:bg-slate-200 focus:outline-none focus:bg-gray-100 p-4 sm:p-6" href="#">
