                        ...
                        <div class="space-y-6 mt-4">
                            ...
                            <div class="lg:flex gap-x-5 space-y-5 lg:space-y-0">
                                <div class="space-y-1">
                                    ...
                                    <input required id="ageUserRequest" name="ageUserRequest" type="number" class="py-2 px-3 pe-9 block w-full border border-gray-200 rounded-lg text-base focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none focus:outline-none" placeholder="Enter age">
                                </div>            
                                <div class="flex-1 space-y-1">
                                    ...
                                    <input required id="contactNum" name="contactNum" type="number" class="py-2 px-3 pe-9 block w-full border border-gray-200 rounded-lg text-base focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none focus:outline-none" placeholder="Enter contact number">
                                </div>
                            </div>
                            <div class="space-y-1">
                            ...
                            <div class="space-y-1">
                                ...
                                <textarea required id="purposeText" name="purposeText" type="email" class="py-2 px-3 pe-9 block w-full border border-gray-200 rounded-lg text-base focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none focus:outline-none" placeholder="Enter purpose of request"></textarea>
                            </div>
